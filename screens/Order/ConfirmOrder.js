...
import { styles, whiteColor, primaryColor } from "../../styles/style";
import {
  responsiveFontSize,
  responsiveHeight,
  responsiveWidth,
...
const ConfirmOrder = ({ route }) => {
  ...
  return (
    ...
    >
      ...
      >
        <View style={styles.confirmPageIconContainer}>
          <Ionicons name="checkmark-outline" size={35} color={whiteColor} />
        </View>
        <View style={{ marginTop: responsiveHeight(2) }}>
          <Text style={{ fontFamily: "Regular" }}>Order id : {orderId}</Text>
        </View>
        <View>
          <Text
            style={{
        ...
        <View style={{ marginTop: responsiveHeight(2) }}>
          <TouchableOpacity
            style={{
              ...
              shadowColor: primaryColor, // Shadow color
              paddingVertical: responsiveHeight(1.7),
              paddingHorizontal: responsiveWidth(12),
            }}
            onPress={() => {
              navigation.navigate("customerOrder", { custId: cusId });
            }}
          >
            <Text
              style={{
