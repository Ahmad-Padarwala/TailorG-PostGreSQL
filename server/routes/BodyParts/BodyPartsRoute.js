...
router.route("/addbodypartsdataindress/:uniquecode").post(BodyPart.addBodyPartDataInDress);
router.route("/addnewbodypartinmeasurement").post(BodyPart.addNewBodypartinmeasurement);
